 ...
 * Menu dropdown avec Aide et Thème (et optionnellement exports)
 */
...
export function DropdownMenu({ onExportPDF, onExportText }: DropdownMenuProps) {
