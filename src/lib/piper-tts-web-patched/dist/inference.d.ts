...
interface TtsSessionOptions {
  ...
  /**
   * Speaker ID for multi-speaker models (optional, default: 0)
   * Used to select different voices in models that support multiple speakers.
   * Example: fr_FR-upmc-medium has 2 speakers (0=Jessica, 1=Pierre)
   */
  speakerId?: number
}
export declare class TtsSession {
  ...
  constructor({ voiceId, progress, logger, wasmPaths, speakerId }: TtsSessionOptions)
